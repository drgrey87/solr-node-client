...
Query.prototype.facet = function(options){
   ...
   //todo prefix will apply to all fields
   if(options.prefix && options.field){
     options.field.forEach(field => {
       this.parameters.push(`f.${field}.facet.prefix=` + encodeURIComponent(options.prefix))
     });
   }
   if(options.sort){
